                            ...
                            serde_json::Value::String(stream_name) => {
                                if stream_val["data"].is_object() {
                                    if stream_name.contains("markPrice") {
                                        ...
                                        let mut stream_val_data = stream_val["data"].take();
                                        let stream_data = stream_val_data.clone().as_object().unwrap();
